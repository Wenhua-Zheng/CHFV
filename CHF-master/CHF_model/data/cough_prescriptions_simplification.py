need_explore = {'荆芥': 2, '乌梅': 1, '桂心': 1, '干姜': 3, '紫菀': 3, '白前': 2, '栀子': 3, '阿胶': 1, '诃子': 1,
                '陈皮': 8, '知母': 4, '防风': 1, '石膏': 2, '大枣': 3, '瓜蒌仁': 4, '松子仁': 1, '杏仁': 8, '枳实': 1,
                '细辛': 3, '人参': 5, '半夏': 10, '浙贝母': 6, '款冬花': 5, '前胡': 6, '甘草': 10, '黄芩': 5, '桔梗': 8,
                '麻黄': 4, '白芍': 2, '茯苓': 10, '当归': 2, '五味子': 3, '紫苏叶': 2, '白果': 1, '桑皮': 4,
                '炙甘草': 3, '百部': 3, '紫苏子': 2, '陈皮': 2, '白术': 2, '黄芪': 2, '厚朴': 1, '枳壳': 3, '生姜': 3,
                '陈皮': 2, '麦冬': 3}
prescriptions = {
